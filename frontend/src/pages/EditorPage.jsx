...
function EditorPage() {
    ...
    // FIXED: Updated handleRunCode with correct backend URL
    const handleRunCode = async () => {
        ...
        try {
            ...
            // FIXED: Use correct backend URL with /api/execute endpoint
    ...
    useEffect(() => {
        if (!authLoading && user) {
            ...
            // FIXED: Use correct backend URL for Socket.io connection
